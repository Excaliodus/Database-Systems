...
if exists	(select *
		from Items as i
		where i.ItemNo=@itemno and i.[Quantity in Store]<@quantity)
begin
set @msg='Only <quantity in store> is present, which is less than your required quantity.'
end
else 
begin
declare @storedquantity int
select @storedquantity=i.[Quantity in Store] from Items as i where i.ItemNo=@itemno
declare @newquantity int 
set @newquantity=@storedquantity-@quantity
insert into OrderDetails
values (@orderno,@itemno,@newquantity)
end
END
